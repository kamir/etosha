package org.etosha.tools.corpusprofiler.mr;
...
public class WordContextMapper2 extends Mapper<Text, Text, Text, IntWritable> {
  ...
  public void map(Text key, Text value, Context context)
      ...
      context.write( key, new IntWritable( bS.length() ) );
