 ...
 * @author kamir
 */
public class DAProjectContext {
    
    Vector<String> category = null;
    
    /**
     * For the tests we use the 6 static category as in the ConceptBrowser
 DEMO page (http://www.semanpix.de/opendata/etosha/v2/cb.html).
     */
    public DAProjectContext() {
