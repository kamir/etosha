...
//                doc.addField("author", mm.getFrom());
                    ...
                    String temp_message_store_location = "/GITHUB/ETOSHA.WS/etosha-workbench/mail-buffer";

                    File f = new File( temp_message_store_location + "/mail-collection-01/" + messageid + ".txt");
...
//        contexter2 = ContextualizerFactory.getJenaInMemoryContextualizer(FUSEKI_BUFFER_FOLDER + "/MAIL-CONTEXT.ttl");

        contexter2 = ContextualizerFactory.getHBaseContextualizer();
    ...
    public static String FUSEKI_BUFFER_FOLDER = TripleStoreRunner.FUSEKI_DATA_FOLDER;
    ...
    private void importListToPartitions(ArrayList<String> al1) {
        ...
        File f = new File(FUSEKI_BUFFER_FOLDER);
        f.mkdirs();
        ...
        for (String label : al1) {
            ...
            createGraphPartition(label, FUSEKI_BUFFER_FOLDER, name, flush);
