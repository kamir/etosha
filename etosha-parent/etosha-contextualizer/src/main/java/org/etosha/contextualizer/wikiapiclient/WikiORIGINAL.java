 ...
 */
package org.etosha.contextualizer.wikiapiclient;
 ...
 *  @version 0.30
 */
public class WikiORIGINAL implements Serializable
{
    // Master TODO list:
    // *Admin stuff
    // *More multiqueries
     ...
     *  en.wikipedia.org)
     */
    public WikiORIGINAL(String domain)
    {
        this(domain, "/w");
    }
     ...
     *  @since 0.14
     */
    public WikiORIGINAL(String domain, String scriptPath)
    {
  ...
  "WikiORIGINAL.java " + version.
    ...
    {
        if (!(obj instanceof WikiORIGINAL))
            return false;
        return domain.equals(((WikiORIGINAL)obj).domain);
    }
    ...
    /**
     *   Returns a string representation of this WikiORIGINAL.
     *   @return a string representation of this WikiORIGINAL.
     *   @since 0.10
     */
    @Override
  ...
  serialize this WikiORIGINAL first.
     *  @see #login
  ...
  String[] articles = WikiORIGINAL.intersection(wikipedia.getCategoryMembers("All orphaned articles", WikiORIGINAL.MAIN_NAMESPACE),
      wikipedia.getCategoryMembers("All pages needing to be wikified", WikiORIGINAL.MAIN_NAMESPACE));

  // find all (notable) living people who are related to Barack Obama
  String[] people = WikiORIGINAL.intersection(wikipedia.getCategoryMembers("Living people", WikiORIGINAL.MAIN_NAMESPACE),
      wikipedia.whatLinksHere("Barack Obama", WikiORIGINAL.MAIN_NAMESPACE));
  </pre>
     *
  ...
  String[] articles = WikiORIGINAL.relativeComplement(wikipedia.getCategoryMembers("Craters on Mars"),
      wikipedia.whatTranscludesHere("Template:MarsGeo-Crater", WikiORIGINAL.MAIN_NAMESPACE));

  // find all images without a description that haven't been tagged "no license"
  String[] images = WikiORIGINAL.relativeComplement(wikipedia.getCategoryMembers("Images lacking a description"),
  ...
  Changes in this map do not propagate back to this WikiORIGINAL object.
     *  @throws IOException if a network error occurs
     *  @since 0.28
     */
  ...
  pages. Check [[User talk:MER-C/WikiORIGINAL.java#Special page equivalents]]
  for fetching the contents of special pages. Use <tt>getImage()</tt> to
     ...
     *  <tt>getLogEntries(null, null, Integer.MAX_VALUE, WikiORIGINAL.UPLOAD_LOG,
  title, WikiORIGINAL.FILE_NAMESPACE)</tt>, as the image may have been deleted.
  ...
  WikiORIGINAL.MAIN_NAMESPACE).length</tt> > 50000.
     *
    ...
    public String[] imageUsage(String image, int... ns) throws IOException
    {
        ...
        do
        {
            ...
            // xml form: <iu pageid="196465" ns="7" title="File talk:WikiORIGINAL.png" />
    ...
    public class User implements Cloneable
    {
         ...
         *  <li><b>gender</b>: (WikiORIGINAL.Gender) the user's gender
  <li><b>created</b>: (Calendar) when the user account was created
        ...
        {
            return WikiORIGINAL.this.contribs(username, ns);
        }
  ...
  implied. Use WikiORIGINAL.class methods to achieve this.
         *
         ...
         */
        @Override
        public int compareTo(WikiORIGINAL.LogEntry other)
        {
    ...
    public class Revision implements Comparable<Revision>
    {
        ...
        public int hashCode()
        {
            return (int)revid * 2 - WikiORIGINAL.this.hashCode();
        }
         ...
         */
        @Override
        public int compareTo(WikiORIGINAL.Revision other)
        {
            if (timestamp.equals(other.timestamp))
                return 0; // might not happen, but
            return timestamp.after(other.timestamp) ? 1 : -1;
        ...
        {
            WikiORIGINAL.this.rollback(this, false, "");
        }
        ...
        {
            WikiORIGINAL.this.rollback(this, bot, reason);
        }
    }
