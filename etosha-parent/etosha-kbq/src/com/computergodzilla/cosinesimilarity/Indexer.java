...
public class Indexer {
    ...
    public Indexer(String sd, String id, String field1, String field2) {
        Configuration.SOURCE_DIRECTORY_TO_INDEX = sd;
        Configuration.INDEX_DIRECTORY = id;
        Configuration.FIELD_CONTENT_1 = field1;
        Configuration.FIELD_CONTENT_2 = field2;
        ...
        fieldName = Configuration.FIELD_CONTENT_1;

        this.indexDirectory.mkdirs();
        this.sourceDirectory.mkdirs();
        
        System.out.println(">>> Documents to work on : " + sd);
