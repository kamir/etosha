...
public class Test11 {
    ...
    public static void getCosineSimilarity() throws LockObtainFailedException, IOException
    {
       ...
       String experimentToRun = "exp1";
       Indexer.useNgramsAsTerms = false;
       Indexer.N = 1;
              
       netFolder = new File( "./networks/FAQ_" + experimentToRun + "_" + System.currentTimeMillis() + "_corpus_net" );
       netFolder.mkdirs();
       ...
       brLINKS.write( "Source\tTarget\tWeight\tJSD\tLabel\n" );
       brNODES.write( "Id\tWeight\n" );
       
 //      Indexer index = new Indexer( "./docs/"+experimentToRun+"/all", "./index/"+experimentToRun+"/indexFromHDFS2", "text" );
       Indexer index = new Indexer( "./docs/"+experimentToRun+"/all", "./index/"+experimentToRun+"/all", "question", "answer" );
       // index.index();
