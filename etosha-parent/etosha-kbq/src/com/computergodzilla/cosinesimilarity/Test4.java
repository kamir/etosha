...
public class Test4 {
    ...
    public static void getCosineSimilarity() throws LockObtainFailedException, IOException
    {
       ...
       Indexer index = new Indexer( "./docs/"+experimentToRun+"/all", "./index/"+experimentToRun+"/all_2", "text", "answer" );
       index.index();
