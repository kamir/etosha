...
import org.sonatype.mavenbook.weather.ContextService;
...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		main.contextService = (ContextService) context.getBean("weatherService");
	...
	public void getWeather() throws Exception {
		Weather weather = contextService.retrieveForecast(zip);
		weatherDAO.save( weather );
		System.out.print(new ContextFormatter().formatWeather(weather));
	}

	public void getHistory() throws Exception {
		Location location = locationDAO.findByZip(zip);
		List<Weather> weathers = weatherDAO.recentForLocation(location);
		System.out.print(new ContextFormatter().formatHistory(location, weathers));
	}
}
