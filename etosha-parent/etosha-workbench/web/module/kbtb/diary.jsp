...
<div id="tab-10" style="width: 97%; height: 720px;">
    ...
    <div id="refinder">    
         <iframe id="refinderview" style="width:100%;height: 710px;" frameborder="0" src="http://localhost:8088/Etosha_DocWorld/index.html">
         </iframe>
    </div>
</div>    
<!--script>
