...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en">	
    ...
    <body> 
        ...
        <div style="position:absolute;left:680px;height:480px;top:10px;font-family:Verdana;font-size:9pt;background-color:#CACACA;width:300px">
			<div style="padding: 5px 5px 5px 5px;font-size:15px;font-weight:bold;text-align:center;margin-top:10px;">FlexPaper Two-Page Mode</div>

			<div style="padding: 5px 5px 5px 5px;font-size:11px;text-align:left;margin-bottom:10px;">This example shows how FlexPaper can be set to start up in 'Two-Page' mode from the start.</div>
			<div style="background-color:#EFEFEF">
				...
				<div style="padding: 5px 5px 5px 5px;font-size:11px;text-align:left;margin-bottom:10px;line-height:150%">
						» <a href="two_page.html">FlexPaper starting up in Two-Page mode</a><br/>
						» <a href="singlepage.html">FlexPaper using SinglePage mode</a><br/>
						» <a href="interactive_API.html">Interactive API html page</a><br/>
						» <a href="searchmatchall.html">Search and highlight all matches</a><br/>
						</div>
