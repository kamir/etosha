...
<body>
  ...
  <table >
    ...
    <tr>
        ...
        <td>
            <button type="button" onclick="storeGnuplotFile()">Speichern</button></td>            
        </td>
    </tr>
    </table>
    ...
    <div id="editor"><%
        ...
        if( allCharts != null ) {
            ...
            if ( projekt != null ) gnuplotData = projekt.loadTextFromFile( projekt.getElementChartGnuplotFile() );
        }    
        
        System.out.println(" ... lade Gnuplot-File ... " + chartId );
...
function storeGnuplotFile() { 
    ...
    myForm.method="post" ;
    myForm.action = "storeGnuplotFile.jsp?chartID=<%= chartId %>" ;
