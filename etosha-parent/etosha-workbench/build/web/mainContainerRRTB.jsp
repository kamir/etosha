<div id="container">
    ...
    <ul>
        ...
        <li><a href="#tab-3"><span>WebSceye Scanner</span></a></li>       

    </ul>

    <jsp:include page="module/files.jsp" />
    <jsp:include page="module/preview.jsp" />
    <jsp:include page="module/tex.jsp" />  
    <jsp:include page="module/gnuplot.jsp" />  
