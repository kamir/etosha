 ...
 */
public class QRServiceIdentifyerGenerator1 {
    ...
    private void generate(File outputFile) throws IOException {
        ...
        String[] paramArr = new String[] {"Hallo Doreen,", "Ich liebe DICH!", "\nDein Mirko. " };
    ...
    public static void main(String[] args) {
        try {
            QRServiceIdentifyerGenerator1 app = new QRServiceIdentifyerGenerator1();
