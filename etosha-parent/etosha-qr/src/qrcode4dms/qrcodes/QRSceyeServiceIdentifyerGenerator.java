 ...
 */
public class QRSceyeServiceIdentifyerGenerator {

    private void generate(File outputFile) throws IOException {
        
        String msg = "WebSceyeService-Locator";
        
        //String[] paramArr = new String[] {"URL=192.168.0.1", "APP=websceye", "USER=mirko.kaempf@bitocean.de"};
        
        String[] paramArr = new String[] { "WebSceye Service URI", "http://127.0.0.1:8080/WebSceye/wspID=0123456  ", "(C) Silvercreations AG"};
        int[] fSizes = {16, 12, 10 };
        
        run( paramArr, fSizes, outputFile );
    }
    
    public static void run(String[] paramArr, int[] fSizes, File outputFile ) throws IOException {
        
        //Create the barcode bean
        DataMatrixBean bean = new DataMatrixBean();
        String msg = paramArr[1];

        final int dpi = 300;

        //Configure the barcode generator
        bean.setModuleWidth(UnitConv.in2mm(10.0f / dpi)); //makes a dot/module exactly eight pixels
    ...
    public static void main(String[] args) {
        try {
            QRSceyeServiceIdentifyerGenerator app = new QRSceyeServiceIdentifyerGenerator();
            File outputFile = new File("sceye_out.png");
