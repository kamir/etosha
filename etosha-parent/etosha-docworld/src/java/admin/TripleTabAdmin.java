 ...
 * 
 */
public class TripleTabAdmin {

    public static final String docTabName = "docworld.triples"; 
    public static final String colFamNameR = "raw"; 
    public static final String colFamNameM = "metadata.tika"; 
    public static final String colFamNameS = "triple"; 
    
    public static String[] FIELDS = { "g", "s", "p", "o" };
