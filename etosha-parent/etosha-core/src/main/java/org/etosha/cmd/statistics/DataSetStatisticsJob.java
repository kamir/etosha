package org.etosha.cmd.statistics;
...
import org.etosha.cmd.jobprofiler.ExtractJobTaskTimeline;
import org.etosha.cmd.jobprofiler.JobHistoryHelper;
...
public class DataSetStatisticsJob extends DataSetInspector {
	...
	public int doRunJob(String[] args) {
		...
		try {
			 ...
			 */
			job.setMapperClass(org.etosha.mr.datasetprofiler.SimpleTableMapper.class);
			job.setReducerClass(org.etosha.mr.datasetprofiler.MultiStatsReducer.class);
