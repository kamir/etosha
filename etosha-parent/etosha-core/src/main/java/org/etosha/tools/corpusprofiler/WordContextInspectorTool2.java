...
import org.etosha.tools.corpusprofiler.mr.SumReducer;
import org.etosha.tools.corpusprofiler.mr.WordContextMapper2;
 ...
 */
public class WordContextInspectorTool2 extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception  {
		...
		if (args.length != 2) {
			System.out
					.printf("Usage: WordContextInspector2 <input dir> <output dir>\n");
			System.exit(-1);
		}
		 ...
		 */
		job.setJarByClass(WordContextInspectorTool2.class);

		/*
		 * Specify an easily-decipherable name for the job. This job name will
		 * appear in reports and logs.
		 */
		job.setJobName("Word Context Inspector #2");
		 ...
		 */
		job.setMapperClass(WordContextMapper2.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int exitCode = ToolRunner.run( cfg, new WordContextInspectorTool2(), args);
