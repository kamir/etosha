...
import org.etosha.tools.corpusprofiler.mr.WordMapper;
 ...
 */
public class CorpusInspectorTool {
  ...
  public static void main(String[] args) throws Exception {
    ...
    if (args.length != 2) {
      System.out.printf(
          "Usage: CorpusInspector <input dir> <output dir>\n");
      System.exit(-1);
    }
     ...
     */
    job.setJarByClass(CorpusInspectorTool.class);
    
    /*
     * Specify an easily-decipherable name for the job.
     * This job name will appear in reports and logs.
     */
    job.setJobName("Corpus Inspector");
